...
| Пресет | Категория | Сетка | Вместимость | Описание |
|--------|-----------|-------|-------------|----------|
| `2x2` | Сетки | 2×2 | 4 блока | Простая сетка 2×2 |
| `3x3` | Сетки | 3×3 | 9 блоков | Простая сетка 3×3 |
| `4x4` | Сетки | 4×4 | 16 блоков | Простая сетка 4×4 |
| `sidebar` | Лейауты | 3×12 | ∞ | Сайдбар слева + контент |
| `sidebar-right` | Лейауты | 3×12 | ∞ | Сайдбар справа + контент |
| `dashboard` | Лейауты | 3×12 | ∞ | Главный блок + виджеты + метрики |
| `holy-grail` | Лейауты | 3×12 | ∞ | Header + Footer + 3 колонки |
| `kanban` | Специальные | 2×3 | 3 блока | Доска: To Do, In Progress, Done |
| `gallery` | Специальные | 2×12 | ∞ | Большие и маленькие карточки |
| `calendar` | Специальные | 5×7 | 35 блоков | Календарь на месяц |
