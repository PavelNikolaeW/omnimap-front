...
<p><em>Переключайтесь между деревьями: <kbd>Space</kbd> + цифра (0-9)</em></p>`,
        ...
        children: ['homepage', 'nav', 'create', 'organize', 'advanced']
    },
    ...
    homepage: {
        ...
        data: {
            text: `<h3>Структура вашего экзокортекса</h3>
<p>Ваша главная страница организована в 6 блоков:</p>
<ul>
<li><strong>Inbox</strong> — входящие заметки и быстрые записи</li>
<li><strong>Focus</strong> — текущие приоритеты и задачи на сегодня</li>
<li><strong>Projects</strong> — активные проекты</li>
<li><strong>Areas</strong> — области ответственности</li>
<li><strong>Spaces</strong> — общие пространства для команд</li>
<li><strong>Archive</strong> — завершённые проекты и архив</li>
</ul>`,
            color: [160, 70, 60] // Бирюзовый
        },
        children: ['homepage-inbox', 'homepage-workflow']
    },

    'homepage-inbox': {
        title: 'Inbox — входящие',
        data: {
            text: `<h4>Как работает Inbox</h4>
<p><strong>Inbox</strong> — это место для быстрых записей и входящей информации.</p>
<p><em>Особенность:</em> Inbox настроен в режиме <strong>Sandbox</strong> — любой человек, которому вы дадите доступ, сможет создавать в нём записи.</p>
<p><strong>Рекомендация:</strong></p>
<ul>
<li>Записывайте всё, что приходит в голову, в Inbox</li>
<li>Регулярно разбирайте Inbox и перемещайте записи в подходящие блоки</li>
<li>Старайтесь держать Inbox пустым к концу дня</li>
</ul>`,
            color: [160, 70, 65]
        },
        children: []
    ...
    'homepage-workflow': {
        ...
        data: {
            text: `<h4>Рекомендуемый рабочий процесс</h4>
<ol>
<li><strong>Сбор</strong> — записывайте всё в Inbox</li>
<li><strong>Обработка</strong> — разбирайте Inbox: удаляйте, делегируйте или перемещайте</li>
<li><strong>Организация</strong> — распределяйте по Projects, Areas или Archive</li>
<li><strong>Фокус</strong> — выбирайте 1-3 задачи в Focus на день</li>
<li><strong>Выполнение</strong> — работайте над задачами из Focus</li>
</ol>
<p><strong>Совет:</strong> Используйте <kbd>Shift+X</kbd> чтобы вырезать блок и <kbd>Shift+V</kbd> чтобы вставить его в другое место.</p>`,
            color: [160, 70, 65]
        },
        children: []
    },
