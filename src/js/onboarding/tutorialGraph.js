 ...
 * - 8 разделов: Быстрый старт, Главная страница, Focus система,
 *   Права доступа, Редактор раскладки, Организация,
 *   Совместная работа, Дополнительные инструменты
 *
...
<p><kbd>Space</kbd> + цифра (0-9) — переключение между деревьями</p>`,
        ...
        children: ['quickStart', 'homePage', 'focusSystem', 'permissions', 'layoutEditor', 'organization', 'collaboration', 'advancedTools']
    },
...
<ul>
<li><kbd>Shift+G</kbd> — вставить ссылку на блок</li>
<li>Изменения синхронизируются с оригиналом</li>
</ul>`,
            color: [45, 70, 75]
        },
...
<p><strong>Создание:</strong> <kbd>Shift+G</kbd> после копирования</p>`,
            color: [45, 70, 75]
        },
        children: []
    },
...
<p><kbd>M</kbd> — открыть единый чат (личные, групповые и AI)</p>
<p><strong>Возможности:</strong></p>
<ul>
...
<ul>
<li>Откройте настройки подписки и удалите её</li>
</ul>`,
            color: [180, 60, 70]
        },
        children: []
    ...
    // ═══════════════════════════════════════════════════════════════════════════
    // Раздел 8: Дополнительные инструменты
    // ═══════════════════════════════════════════════════════════════════════════
    advancedTools: {
        title: '8. Дополнительные инструменты',
        data: {
            text: `<h5>Расширенные возможности</h5>
<p>Инструменты для ускорения работы и командных сценариев.</p>`,
            color: [330, 70, 62]
        },
        children: ['images', 'urls', 'imports', 'accessRequests', 'notificationSettings']
    },

    images: {
        title: 'Изображения блоков',
        data: {
            text: `<h6>Иллюстрации и обложки</h6>
<ul>
<li><kbd>I</kbd> — загрузить/изменить изображение блока</li>
<li><kbd>V</kbd> — открыть изображение на полный экран</li>
</ul>
<p>Используйте изображения для визуальной навигации в крупных деревьях.</p>`,
            color: [330, 60, 72]
        },
        children: []
    },
    ...
    urls: {
        title: 'URL-ссылки на блок',
        data: {
            text: `<h6>Публичные и внутренние ссылки</h6>
<ul>
<li><kbd>Shift+U</kbd> — открыть менеджер URL текущего блока</li>
<li>Создавайте понятные short-link ссылки для команды</li>
<li>Удаляйте устаревшие ссылки из того же окна</li>
</ul>`,
            color: [330, 60, 72]
        },
        children: []
    ...
    imports: {
        title: 'Импорт блоков',
        data: {
            text: `<h6>Загрузка структуры из JSON</h6>
<ul>
<li><kbd>Shift+I</kbd> — открыть импорт</li>
<li>Импорт выполняется в выбранный блок-контейнер</li>
<li>Подходит для переноса шаблонов и миграций</li>
</ul>`,
            color: [330, 60, 72]
        },
        children: []
    ...
    accessRequests: {
        ...
        data: {
            text: `<h6>Обработка запросов от пользователей</h6>
<ul>
<li><kbd>Shift+O</kbd> — открыть список запросов доступа</li>
<li>Подтверждайте или отклоняйте входящие заявки</li>
<li>Отслеживайте статус отправленных запросов</li>
</ul>`,
            color: [330, 60, 72]
        },
        children: []
    ...
    notificationSettings: {
        ...
        data: {
            text: `<h6>Персональные уведомления</h6>
<ul>
<li><kbd>Shift+N</kbd> — открыть настройки уведомлений</li>
<li>Выбирайте, какие события и как часто получать</li>
<li>Настройте комфортный режим для напоминаний и подписок</li>
</ul>`,
            color: [330, 60, 72]
        },
        children: []
